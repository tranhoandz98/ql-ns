...
@section('script')
    ...
    <script>
        ...
        function getRemainingLeave(event) {
            ...
            fetch("{{ route('kpi_user.getByUser') }}?user_id=" + userId)
        ...
        <div class="row">
            ...
            <div class="col-md-6 ">
                <div class="form-group mb-4">
                    <x-input-label for="remaining_leave_days">
                        @lang('messages.kpi-remaining_leave_days')
                    </x-input-label>
            ...
            <div class="form-group mb-4 col-6">
                <x-input-label for="handover_recipient">
                    @lang('messages.kpi-handover_recipient')
                </x-input-label>
            ...
            <div class="form-group mb-4 col-6">
                <x-input-label for="handover_date">
                    @lang('messages.kpi-handover_date')
                </x-input-label>
