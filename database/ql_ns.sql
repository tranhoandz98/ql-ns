...
-- Records of cache
-- ----------------------------
INSERT INTO `cache` VALUES ('laravel_cache_sdmfmskmf@yopmail.com|::1:timer', 'i:1742121146;', 1742121146);
INSERT INTO `cache` VALUES ('laravel_cache_sdmfmskmf@yopmail.com|::1', 'i:1;', 1742121146);
...
CREATE TABLE `departments`  (
  ...
  `
founding_at` timestamp NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `departments` VALUES (1, 'Nhóm Dev', NULL, 0, NULL, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `departments` VALUES (2, 'Phòng kinh doanh', NULL, 0, NULL, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `position` VALUES (2, 'Giám đốc', 'đây là giám đốc \r\nđây là giám đốc\r\nđây là giám đốcđây là giám đốcđây là giám đốcđây là giám đốcđây là giám đốc\r\nđây là giám đốcđây là giám đốcđây là giám đốcđây là giám đốc', 1, 1, '2025-03-16 07:45:13', '2025-03-16 07:45:13');
...
INSERT INTO `roles` VALUES (2, 'Nhân viên ng dùng', NULL, 1, NULL, '2025-03-16 03:55:57', '2025-03-16 03:55:57');
...
-- Records of sessions
-- ----------------------------
INSERT INTO `sessions` VALUES ('O6njCegRDas18QRMKFDI4nZn6ablvsCYJhcfRnxA', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '', 1742123836);
INSERT INTO `sessions` VALUES ('h9Xu5KjRpH27rpyVJjlVY5MDAwPAr8PVl3VIns9G', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '', 1742126138);
...
CREATE TABLE `users`  (
  ...
  `type` int NULL DEFAULT NULL COMMENT '(object)[\r\n                \"id\" => 1,\r\n                \"name\" => \'Admin\',\r\n            ],\r\n            (object)[\r\n                \"id\" => 2,\r\n                \"name\" => \'Cán bộ quản lý\',\r\n            ],\r\n            (object)[\r\n                \"id\" => 3,\r\n                \"name\" => \'Nhân viên\',\r\n            ]',
